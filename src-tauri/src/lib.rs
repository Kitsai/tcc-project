...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::checker::create_checker_test,
            commands::checker::edit_checker_test,
            commands::checker::delete_checker_test,
            commands::checker::run_checker_tests,
            ...
            commands::tests::get_next_test_id,
